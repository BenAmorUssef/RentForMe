...
import tn.isi.ussef.rentforme.dummy.DummyContent;
...
public class HouseListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View recyclerView = findViewById(R.id.house_list);
    ...
    public class SimpleItemRecyclerViewAdapter
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.house_list_content, parent, false);
            ...
            holder.mView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mTwoPane) {
                        ...
                        arguments.putString(HouseDetailFragment.ARG_ITEM_ID, holder.mItem.id);
                        ...
                        intent.putExtra(HouseDetailFragment.ARG_ITEM_ID, holder.mItem.id);
